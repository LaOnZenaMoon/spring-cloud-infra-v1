...
public class ResponseLogFilter extends ZuulFilter {
    ...
    private void responseLog(RequestContext context, String responseData) {
        ...
        log.info("Response [{} {}, client={}, authorization={}, timestamp={}] [{}] [{}ms] responseBody={}", request.getMethod(), request.getRequestURL().toString(), remoteIp, authorization, timestamp, status, duration, responseData);
    }
}
